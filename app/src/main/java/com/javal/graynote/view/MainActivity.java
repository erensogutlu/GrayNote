...
import com.javal.graynote.adapter.NotesAdapter;
import com.javal.graynote.database.NotesDatabase;
import com.javal.graynote.entities.Note;
import com.javal.graynote.listeners.NotesListener;
...
public class MainActivity extends AppCompatActivity implements NotesListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_ADD_NOTE && resultCode == RESULT_OK) {
            ...
            if (data != null) {
              getNotes(REQUEST_CODE_UPDATE_NOTE,data.getBooleanExtra("İsNoteDeleted",false));
            }
        }
    }
